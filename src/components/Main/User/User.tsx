    ...
    return (
        <div className="user">
            ...
            <img
                ...
                style={{display: fetchingPhoto ? 'none' : 'block'}}
                src={dataUser.avatar_url ? dataUser.avatar_url : ''}
                alt="user"
            />
            ...
            <div className="user__description">
                ...
                <div className="user__followers">
                    <p>
                        <svg className="iconUsers" width="23" height="15" viewBox="0 0 23 15"
                    ...
                    <p>
                        <svg className="iconUser" width="25" height="25" viewBox="0 0 25 25"
                             xmlns="http://www.w3.org/2000/svg">
                            <path
